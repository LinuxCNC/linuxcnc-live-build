...
This way you update the package indices for all repositories and upgrade to the latest LinuxCNC packages,
be they provided from the Debian Linux distribution or by the LinuxCNC community's buildbots.

These additional repositories include:
...
For further information about configuring Debian 12 (Bookworm), refer to the Getting LinuxCNC
chapter https://linuxcnc.org/docs/stable/html/getting-started/getting-linuxcnc.html in the 2.9 Documents.
